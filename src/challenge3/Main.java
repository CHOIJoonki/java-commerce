...
public class Main {
    public static void main(String[] args) {
        ...
        customers.add(new Customer("홍길동", "hong@email.com"));
        customers.add(new Customer("김영희", "kim@email.com"));
        customers.add(new Customer("이철수", "lee@email.com"));
        customers.add(new Customer("박지민", "park@email.com"));

        // CommerceSystem 객체 생성 및 시작
